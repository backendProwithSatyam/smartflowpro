...
{{-- 
    ...
    <div class="section">
      ...
      <div class="tab-content" id="requests"><p>No requests yet</p></div>
      <div class="tab-content" id="quotes"><p>No quotes yet</p></div>
      <div class="tab-content" id="jobs"><p>No jobs yet</p></div>
      <div class="tab-content" id="invoices"><p>No invoices yet</p></div>
    </div>
