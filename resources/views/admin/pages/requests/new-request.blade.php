...
.top-section-bg {
    background-color: #f9f8f6; /* Light gray background for top */
    padding: 1.5rem;
}
...
$client_name = isset($serviceRequest) && $serviceRequest->client ? $serviceRequest->client->title . ' ' .
$serviceRequest->client->first_name . ' ' . $serviceRequest->client->last_name : '';
@endphp
@section('content')
<div class="container mt-4">
    <div class="card new_request-card shadow-sm">
        <!-- Top section with background -->
        <div class="card-body top-section-bg">
            <div class="form-top-section">
                <div class="d-flex align-items-center gap-3 mb-3">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                        style="fill: var(--color-icon); width:24px; height:24px;">
                        <path d="M12 2a1 1 0 0 0-1 1v5.586L9.707 7.285A.998.998 0 0 0 8 8c.002.253.1.506.293.699l3 3.008a.997.997 0 0 0 1.414 0l3.022-3.293a.996.996 0 0 0 0-1.414.997.997 0 0 0-1.414 0L13 8.586V3a1 1 0 0 0-1-1Z" style="fill: var(--color-request);"></path>
                        <path d="M2 5a2 2 0 0 1 2-2h4v2H4v9h5a1 1 0 0 1 .894.553L10.618 16h2.764l.724-1.447A1 1 0 0 1 15 14h5V5h-4V3h4a2 2 0 0 1 2 2v15a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5Zm18 11h-4.382l-.724 1.447A1 1 0 0 1 14 18h-4a1 1 0 0 1-.894-.553L8.382 16H4v4h16v-4Z" style="fill: var(--color-request);"></path>
                    </svg>
                    <span class="fw-bold">{{ isset($serviceRequest) ? 'Edit Request' : 'New Request' }}</span>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="dropdown-search">
                        ...
                        <input type="hidden" name="client_id" id="client_id"
                            value="{{ old('client_id', $serviceRequest->client_id ?? '') }}">
                        <ul class="dropdown-menu" id="clientDropdown">
                            @foreach ($clients as $client)
                            <li><a class="dropdown-item" href="#" data-value="{{ $client->id }}"
                                    data-text="{{ $client->title }} {{ $client->first_name }} {{ $client->last_name }}">{{ $client->title }}
                                    {{ $client->first_name }} {{ $client->last_name }}</a></li>
                            @endforeach
                        </ul>
                    </div>
                ...
                <div class="mb-0">
                    <small class="text-muted">Requested on<br>{{ date('F j, Y') }}</small>
                </div>
            </div>
        </div>
        ...
        <div class="card-body">
           <form id="requestForm" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <div>
                        ...
                        <textarea name="service_details" class="form-control" rows="4"
                            ...
                            required>{{ old('service_details', $serviceRequest->service_details ?? '') }}</textarea>
                ...
                <div class="mb-4">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" value="anytime" id="anytime"
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" value="afternoon" id="afternoon"
                                name="preferred_times[]"
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" value="evening" id="evening"
                                name="preferred_times[]"
                ...
                <div class="mb-4">
                    ...
                    <div class="inline-form" id="onsiteForm"
                        style="{{ old('onsite_assessment', $serviceRequest->onsite_assessment ?? false) ? 'display: block;' : 'display: none;' }}">
                        ...
                        <div class="mb-3">
                            ...
                            <div id="scheduleInputs"
                                class="{{ old('onsite_schedule_later', $serviceRequest->onsite_schedule_later ?? false) ? 'schedule-disabled' : '' }}">
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                ...
                                <div class="form-check mb-3">
                                    <input class="form-check-input" type="checkbox" id="anytimeSchedule"
                                        name="onsite_anytime"
                ...
                <div class="mb-4">
                    ...
                    <div class="inline-form" id="notesForm"
                        style="{{ old('notes', $serviceRequest->notes ?? '') ? 'display: block;' : 'display: none;' }}">
                        <div class="mb-3">
...
<div class="bottom-bar">
    <div class="container d-flex justify-content-end gap-2">
        <button type="button" class="btn btn-primary-custom me-2"
            onclick="window.location.href='{{ route('requests.index') }}'">Cancel</button>
...
<script>
    ...
    function submitForm() {
        ...
        const url =
            '{{ isset($serviceRequest) ? route("requests.update", $serviceRequest->id) : route("requests.store") }}';
