...
@section('content')
    <div class="d-flex justify-content-center align-items-center" style="min-height: 70vh;">
        <div class="container">
            ...
            <form id="jobForm" method="POST" class="mt-2"
                ...
                @endif
                <div class="card">
                    <div class="card-body p-0" style="border-top:.375rem solid hsl(107, 58%, 33%);border-radius:8px 8px 0px 0px;">
                        <!-- Header Section -->
                        <div class="form-section" style="background: hsl(45, 20%, 97%);">
                            <div class="row">
                                <h5 class="page-title">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" data-testid="job"
                                        style="fill: hsl(198, 35%, 21%); display: inline-block; vertical-align: middle; width: 24px; height: 24px;">
                                        <path
                                            ...
                                            style="fill: #276515;"></path>
                                    </svg>
                                    {{ isset($job) ? 'Edit Job' : 'New Job' }}
                                </h5>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            @if($customFields->isNotEmpty())
                                                <table class="table align-middle" style="background: hsl(45, 20%, 97%) !important;">
                                                    <tbody>
                                                        @foreach($customFields as $index => $field)
                                                            <tr style="background: hsl(45, 20%, 97%) !important;">
                                                                <!-- Label -->
                                                                <td class="fw-semibold" style="width: 30%; background: hsl(45, 20%, 97%) !important; @if($index !== $customFields->count() - 1)border-bottom: 1px solid #e5e7eb;@endif">
                                                                    {{ $field->label_name }}
                                                                </td>
                                                                <td style="background: hsl(45, 20%, 97%) !important; @if($index !== $customFields->count() - 1)border-bottom: 1px solid #e5e7eb;@endif">
                                            ...
                                            @endif
                                            <div class="mb-3 newjobs" style="border-bottom: none;">
                                                <label for="addfields" class="form-label">Want to Customize?</label>
                                                <button class="btn btn-custom-secondary btn-sm openModalBtn" type="button"
                                                    data-page-value="jobs" data-bs-toggle="modal"
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-section">
                                ...
                                <div id="oneOffSchedule">
                                    <div class="mb-3">
                                        <span class="text-muted">Total visits 1 | On
                                            {{ request('date') ? \Carbon\Carbon::parse(request('date'))->format('F j, Y') : date('F j, Y') }}</span>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <div class="icon-input">
                                                <input type="date" class="form-control" id="scheduleDate"
                                                    name="schedule_date" value="{{ request('date') ?? date('Y-m-d') }}">
                                                ...
                                                <div class="mb-3">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="repeat_end_type"
                                                            id="endsAfter" value="after" checked
                                                            onchange="toggleEndFields()">
                                                        <label class="form-check-label" for="endsAfter">Ends after</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="repeat_end_type"
                                                            id="endsOn" value="on" onchange="toggleEndFields()">
                                                ...
                                                <div id="endsAfterFields" class="row">
                                                    <div class="col-md-6 mb-3">
                                                        <input type="number" class="form-control"
                                                            name="repeat_end_after_number" value="1" min="1"
                                                            placeholder="Number">
                                                    </div>
                                                    <div class="col-md-6 mb-3">
                                ...
                                <div id="recurringSchedule" style="display: none;">
                                            ...
                                            <div id="recurringRepeatEndOptions" class="mt-3">
                                                <div class="mb-3">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio"
                                                            name="recurring_repeat_end_type" id="recurringEndsAfter"
                                                            value="after" checked onchange="toggleRecurringEndFields()">
                                                        <label class="form-check-label" for="recurringEndsAfter">Ends
                                                            after</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio"
                                                            name="recurring_repeat_end_type" id="recurringEndsOn" value="on"
                                                            onchange="toggleRecurringEndFields()">
                                                        <label class="form-check-label" for="recurringEndsOn">Ends
                                                            on</label>
                                                    </div>
                                                </div>
                                                <div id="recurringEndsAfterFields" class="row">
                                                    ...
                                                    <div class="col-md-6 mb-3">
                                                        <select class="form-select"
                                                            name="recurring_repeat_end_after_period">
                                                            <option value="days">days</option>
                                                            <option value="weeks">weeks</option>
                                                            <option value="months">months</option>
                                                            <option value="years">years</option>
                                                ...
                                                <div id="recurringEndsOnField" class="mb-3" style="display: none;">
                                                    <input type="date" class="form-control"
                                                        name="recurring_repeat_end_on_date">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="d-flex flex-wrap gap-2 mb-2">
                                                <span class="badge bg-secondary">Indigent <i
                                                        class="fas fa-times ms-1"></i></span>
                                                <span class="badge bg-secondary">Puppy Lane <i
                                                        class="fas fa-times ms-1"></i></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            <label for="recurringVisitInstructions" class="form-label">Visit
                                                instructions</label>
                        ...
                        <div class="card-body">
                            <div class="form-section">
                                ...
                                <button type="button" class="btn btn-primary-custom btn-sm" onclick="addProductItem()">
                                    <i class="fas fa-plus me-2"></i>Add New Item
                                </button>
                                <div class="row mt-3" style="border-top:5px solid hsl(200, 13%, 87%);">
    ...
    <div class="fixed-bottom-bar">
        <div class="d-flex justify-content-end gap-3">
            <button type="button" class="btn btn-custom" onclick="window.location.href='{{ route('jobs.index') }}'">
                Cancel
            </button>
