...
class StoreQuoteRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'line_items.*.type' => 'required_with:line_items|in:product,optional,text',
            'line_items.*.attachments' => 'nullable|file|mimes:jpg,jpeg,png|max:10240',
            'line_items.*.required' => 'boolean',
